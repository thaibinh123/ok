...
echo.
echo. -----------------------
SET /P M=Chon phien ban (1,2,3,4,5,6) roi click Enter: 
IF %M%==1 set aa=2010&set yy=Office Professional Plus 2010&goto:1
IF %M%==2 set aa=2013&set yy=Office Professional Plus 2013&goto:1
IF %M%==3 set aa=ProPlus&set yy=Office Professional Plus 2016&goto:1
IF %M%==4 set aa=ProPlus2019&set yy=Office Professional Plus 2019&goto:1
IF %M%==5 set aa=ProPlus2021&set yy=Office Professional Plus 2021&goto:1
IF %M%==6 set aa=O365ProPlus&set yy=Office 365&set off365=ok&goto:1
if [%M%] NEQ 1 goto:startok
if [%M%] NEQ 2 goto:startok
if [%M%] NEQ 3 goto:startok
if [%M%] NEQ 4 goto:startok
if [%M%] NEQ 5 goto:startok
if [%M%] NEQ 6 goto:startok
...
echo.
echo.
choice /c:123 /n /m "Chon phien ban : "
